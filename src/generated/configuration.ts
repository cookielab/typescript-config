...
export const compilerOptionsSchema = z.record(z.string(), z.unknown()).and(z.object({
     ...
     */
    target: z.union([z.union([z.literal("es3"), z.literal("es5"), z.literal("es6"), z.literal("es2015"), z.literal("es2016"), z.literal("es2017"), z.literal("es2018"), z.literal("es2019"), z.literal("es2020"), z.literal("es2021"), z.literal("es2022"), z.literal("es2023"), z.literal("es2024"), z.literal("es2025"), z.literal("esnext")]), z.record(z.string(), z.unknown())]).and(z.union([z.union([z.union([z.literal("es3"), z.literal("es5"), z.literal("es6"), z.literal("es2015"), z.literal("es2016"), z.literal("es2017"), z.literal("es2018"), z.literal("es2019"), z.literal("es2020"), z.literal("es2021"), z.literal("es2022"), z.literal("es2023"), z.literal("es2024"), z.literal("es2025"), z.literal("esnext")]), z.record(z.string(), z.unknown())]).and(z.string()), z.union([z.union([z.literal("es3"), z.literal("es5"), z.literal("es6"), z.literal("es2015"), z.literal("es2016"), z.literal("es2017"), z.literal("es2018"), z.literal("es2019"), z.literal("es2020"), z.literal("es2021"), z.literal("es2022"), z.literal("es2023"), z.literal("es2024"), z.literal("es2025"), z.literal("esnext")]), z.record(z.string(), z.unknown())]).and(z.null())])).optional(),
    /**
